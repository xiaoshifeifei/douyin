...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      let res = await bluevList({
        ...
        .then(res => {
          ...
          console.log("this.$refs.chiidTable.setSelectRow",this.$refs.chiidTable.setSelectRow);
    ...
    changePageCoreRecordData() {
      ...
      console.log('this.multipleSelectionAllthis.multipleSelectionAll',this.multipleSelectionAll);
      ...
      console.log("that.multipleSelectionAll22",that.multipleSelectionAll);
      // 当也未选中ID
      let noSelectIds = [];
