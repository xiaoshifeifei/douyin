    ...
    <el-card>
      <div class="table_top" ref="heightTop">
        <div>
          <el-select v-model="value1" placeholder="会员类型">
            <el-option label="赠送会员" value="0"></el-option>
            <el-option label="月度会员" value="1"></el-option>
            <el-option label="季度会员" value="2"></el-option>
            <el-option label="半年度会员" value="3"></el-option>
            <el-option label="年度会员" value="4"></el-option>
          </el-select>
          <el-select
            ...
            placeholder="订购方式"
          >
            <el-option label="预购会员" value="4"></el-option>
            <el-option label="开通会员" value="1"></el-option>
            <el-option label="续购会员" value="2"></el-option>
            <el-option label="赠送会员" value="3"></el-option>
          </el-select>
          <el-date-picker
            style="margin-left:20px"
            v-model="valueTime"
      ...
      >
        <div class="formStyle">
          ...
          >
            ...
            >
              <el-input
                v-model="myInfo.base_info.serial_number"
                readonly
              ></el-input>
            </el-form-item>
            <el-form-item
            ...
            >
              <el-input
                v-model="myInfo.base_info.recom_tel"
                readonly
              ></el-input>
            </el-form-item>
            <el-form-item
            ...
            >
              <el-input
                v-model="myInfo.base_info.payment_amount"
                readonly
              ></el-input>
            </el-form-item>
            ...
            >
              <el-input
                v-model="myInfo.base_info.purchase_type_text"
                readonly
              ></el-input>
            </el-form-item>
          </el-form>
      ...
      >
        ...
        >
          ...
          <div class="title-t1">抖音号:123456789</div>
          <div class="pl_20">
...
export default {
  ...
  methods: {
    ...
    async handleBatchDownload(selectImgList) {
      ...
      Promise.all(promises).then(() => {
        zip
          ...
          .then(content => {
            // 生成二进制流
            FileSaver.saveAs(content, "会员订单数据.zip"); // 利用file-saver保存文件
          });
      });
      console.log("成功啦");
    },
    ...
    exportExcel() {
      ...
      let tittle =
        thirteenBitTimestamp(new Date().getTime()) + "会员订单数据.xlsx";
      try {
        FileSaver.saveAs(
          new Blob([wbout], {
    ...
    async getList() {
      ...
      let res = await VIPOrder({
        ...
        sellvip_id: this.value1,
        purchase_type: this.value2,
        page: this.page,
        limit: this.limit,
    ...
    handleInfo(roleData) {
      ...
      this.myInfo.base_info = { ...roleData };
      this.dialoInfo = true;
      this.edatPa = "详情";
    },
    // 申请
