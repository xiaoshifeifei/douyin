<template>
  <div id="jurisdiction" class="LoadingArea">
    <el-card>
      ...
      <el-dialog title="编辑" :visible.sync="dialoInfo" width="800">
        <div class="formStyle">
          <el-form
            :model="Info"
            :rules="roleRules"
      ...
      <el-dialog title="授权" :visible.sync="dialogSetting" width="800">
      ...
      <!-- 新增 -->
      <el-dialog title="新增" :visible.sync="addSetting" width="50%">
        <div>
          <div class="base_form">
            <el-form
              :model="ruleForm"
