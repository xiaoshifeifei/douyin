    ...
    <el-card>
      ...
      >
        ...
        >
          <template slot-scope="scope">
             <el-button
              class="class-btn"
              type="success"
              @click="handleVideo(scope.row.url)"
              size="mini"
              >视频播放</el-button
            >
          </template>
        ...
        >
          <template slot-scope="scope">
            <div>
              {{scope.row.is_check == -1 ? '拒绝': scope.row.is_check == 1 ? '审核中': '审核通过'}}
            </div>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template slot-scope="scope">
            ...
            <el-button
              class="class-btn"
              type="warning"
              @click="handleReject(scope.row.video_id)"
    ...
    >
      ...
      >
        <div style="width:80%;margin:auto;">
          <video class="video" :src="this.paUrl" controls="controls">
            </video>
        </div>
      </el-form>
      <span slot="footer">
        <el-button @click="isVideo = false">取消</el-button>
        <!-- <el-button
          v-loading="app.saveLoading"
          type="primary"
          @click="onSaveAdopt"
