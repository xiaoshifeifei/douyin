    ...
    <el-card>
      ...
      >
        ...
        >
          ...
          <el-form-item label="视频名称" class="bgctable ">
            <el-input :value="Info.title" readonly></el-input>
          </el-form-item>
          <el-form-item label="视频大小" class="bgctable ">
            <el-input :value="Info.size" readonly></el-input>
          </el-form-item>
          <el-form-item label="视频播放地址" class="bgctable ">
            <el-input
        ...
        <el-form
          ...
          style="width:90%;margin:auto"
        >
          <div class="divbox" v-if="this.Info.is_check == -1">
            <div class="box-l">
              ...
              <div class="box2">
                {{
                  this.Info.is_check == -1
                    ...
                    : this.Info.is_check == 1
                    ? "审核中"
                    : this.Info.is_check == 2
                    ? "已通过"
                    : ""
                }}: {{ this.Info.check_remark }}
              </div>
              <!-- <div class="box2" v-if="edatPa == '查看审核'">
                已通过
              </div> -->
            </div>
          </div>
      ...
      <el-dialog
        ...
        width="30%"
      >
        <div class="videoGo">该视频确定审核通过吗？</div>
        <div class="video1">
      ...
      >
        ...
        >
          ...
          <el-table-column prop="title" align="center" label="视频名称" />
          ...
          >
            <template slot-scope="scope">
              ...
              <!-- <video class="video" :src="url" controls="controls"> -->
              <!-- </video> -->
            </template>
          </el-table-column>
          <el-table-column prop="checkname" align="center" label="审核状态" />
          <el-table-column prop="create_time" align="center" label="提交时间" />
        </el-table>
      ...
      <el-dialog
        :visible="isVideo"
        title="视频"
        :before-close="isVideoCl"
        :close-on-click-modal="false"
      >
        <el-form ref="detailForm" label-width="150px" label-position="left">
          <div style="width:80%;margin:auto;">
            <video class="video" :src="this.paUrl" controls="controls"></video>
          </div>
        </el-form>
        <span slot="footer">
          <el-button @click="isVideo = false">关闭</el-button>
          <!-- <el-button
...
export default {
  ...
  methods: {
    ...
    async handleBatchDownload(selectImgList) {
      ...
      Promise.all(promises).then(() => {
        zip
          ...
          .then(content => {
            // 生成二进制流
            FileSaver.saveAs(content, "视频审核数据.zip"); // 利用file-saver保存文件
          });
      });
      console.log("成功啦");
    },
    ...
    addProduct() {
      if (
        ...
        for (let val of arrayNew) {
          if (!ary2.some(item => item.video_id == val.video_id)) {
            ary2.push(val);
          }
        }
        this.allArray = ary2;
    ...
    exportExcel() {
      ...
      let tittle =
        thirteenBitTimestamp(new Date().getTime()) + "视频审核数据.xlsx";
      try {
        FileSaver.saveAs(
          new Blob([wbout], {
    ...
    async handleInfo(roleData) {
      ...
      this.isShowP = true;
      this.edatPa = "详情";
      console.log("roleData,", this.edatPa);
    },
    // 申请
